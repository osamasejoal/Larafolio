                                    ...
                                    @forelse ($rc_datas as $rc_data)
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle" class="text-center col-2">
                                                <a href="{{route('relative_companies.edit', $rc_data->id)}}" class="btn btn-info btn-sm mr-2">Edit</a>
                                                <a href="{{route('relative_companies.destroy', $rc_data->id)}}" class="btn btn-danger btn-sm">Delete</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
