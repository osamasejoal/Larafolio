    ...
    <nav class="navbar navbar-expand-lg navbar-dark menu shadow fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item"><a style="text-decoration: none" class="#"
...
////////////////////////////////////////////////////////////////////////////////////////////////////-->
    @if (relative_companies_helper()->count() != 0)
    ...
    <section id="services" class="services">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
                    <div class="services__pic">
                        <img src="{{ asset('frontend/images/services/service-3.png') }}"
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="testimonials__picture">
                                <img src="{{ asset('frontend/images/testimonials/client-1.jpg') }}"
                        ...
                        <div class="carousel-item">
                            ...
                            <!-- client picture  -->
                            <div class="testimonials__picture">
                                <img src="{{ asset('frontend/images/testimonials/client-2.jpg') }}"
                        ...
                        <div class="carousel-item">
                            ...
                            <!-- client picture  -->
                            <div class="testimonials__picture">
                                <img src="{{ asset('frontend/images/testimonials/client-3.jpg') }}"
                        ...
                        <div class="carousel-item">
                            ...
                            <!-- client picture  -->
                            <div class="testimonials__picture">
                                <img src="{{ asset('frontend/images/testimonials/client-4.jpg') }}"
